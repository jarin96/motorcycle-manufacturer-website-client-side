...
const Vehicles = () => {
    return (
        <div>
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl px-12 my-20">
                ...
                <div className="card-body">
                    <h2 className="card-title font-bold">Stree Bike</h2>
                    <h2 className="card-title font-bold">Dirt Bike</h2>
                    <h2 className="card-title font-bold">Scooter Bike</h2>
